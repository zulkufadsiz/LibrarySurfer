	...
	*/
	...
	$order = 0; //order number set to 0; 
	    ...
	    foreach ( $array_items as $item) {
	    	...
	    	$update = "UPDATE about_pictures SET picture_ordering = '$order' WHERE picture_id='$item' "; // MYSQL query that: Update in db_table Order with value $order where rows id equals $item. $item is the number in index.php file: item-3.
