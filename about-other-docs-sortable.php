	...
	*/
	...
	$order = 0; //order number set to 0; 
	    foreach ( $array_items as $item) {
	    	$update = "UPDATE about_other_docs SET doc_ordering = '$order' WHERE doc_id='$item' "; // MYSQL query that: Update in db_table Order with value $order where rows id equals $item. $item is the number in index.php file: item-3.
